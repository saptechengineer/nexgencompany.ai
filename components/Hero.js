...
import nexhero from "@/app/nexhero.png";
    ...
    <section className="max-w-7xl mx-auto bg-base-100 flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-20 px-8 py-8 lg:py-20">
      <div className="flex flex-col gap-10 lg:gap-14 items-center justify-center text-center lg:text-left lg:items-start">
        ...
        <h1 class="font-extrabold text-4xl lg:text-6xl tracking-tight md:-mb-4 flex flex-col gap-3 items-center lg:items-start">
          <span class="relative">Get your enterprise apps</span>
          <span class="whitespace-nowrap relative ">
            <span class="mr-3 sm:mr-4 md:mr-5">in days,
            </span><span class=" relative whitespace-nowrap">
              <span class="absolute bg-neutral-content -left-2 -top-1 -bottom-1 -right-2 md:-left-3 md:-top-0 md:-bottom-0 md:-right-3 -rotate-1">
                </span>
        ...
        Crafting cutting-edge SaaS and AI solutions, data engineering, 
        SAP BTP, and integrated cloud applications for enterprises.
        </p>
      ...
      <div className="lg:w-full">
        <Image
          ...
          // src="https://drive.google.com/file/d/1Lcj8xMWcEZP3rV9o7kEfa5YtCEolbuxH/view"
          // src="../app/nexhero.png"
          src={nexhero}
          alt="Product Demo"
          className="w-full"
