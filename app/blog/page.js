...
export const metadata = getSEOTags({
  title: `${config.appName} Blog | Enterpeise Application Development`,
  description:
    "We are specialized to deliver Enterpeise application and Business AI solutions in days with the help of our pre-build plugins. - NexGenCompany.ai",
